...
import { Calendar, Clock, Users, FileText, Settings, LogOut, Eye, Gavel, CheckCircle, AlertCircle } from 'lucide-react';
...
const AdvocateDashboard = () => {
  ...
  const pendingCases = cases.filter(case_ => case_.status === 'open');

  // Get unique clients
  const uniqueClients = [...new Set(cases.map(case_ => case_.clientId?._id))].length;
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-16">
            <div className="flex items-center">
              <h1 className="text-2xl font-bold text-gray-900">Advocate Dashboard</h1>
            </div>
                    ...
                    <>
                      {activeCases.length > 0 ? (
                        ...
                        <div className="text-center py-8">
                          ...
                          <p className="text-gray-600">No active cases assigned</p>
                        </div>
                      )}
                    </>
                  )}
                    ...
                    <>
                      {pendingCases.length > 0 ? (
                        pendingCases.map((case_) => (
                          <div
                            key={case_._id}
                            className="border rounded-lg p-4 hover:shadow-md transition-shadow cursor-pointer border-yellow-200 bg-yellow-50"
                            onClick={() => navigate(`/cases/${case_._id}`)}
                          >
                            <div className="flex items-start justify-between">
                              <div className="flex-grow">
